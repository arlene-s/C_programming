 ...
 * Purpose:  Fifth version of black jack game
 *           -Created card struct to represent a single card from deck
 *              ~contains: card face, suit, face value
 *           -Created an array of Card struct to represent a deck of 52 cards
 *           -Modified card function for assigning a card to return a string instead of char
 *              ~this will be cards face
 *           -Added a shuffle function to shuffle the deck of 52 cards
 *           -Added suits to display with card face
 */
