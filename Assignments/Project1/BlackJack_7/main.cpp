 ...
 * Purpose:  Seventh version of black jack game
 *           -Created an enum of face cards, used to assign cards to deck array
 *           -Changed static array suits[] to a C-string, used to assign suit to card
 */
...
int main(int argc, char** argv) {
    ...
    if(binFile){
        ...
        cout<<"***************************************"<<endl;
        cout<<"Games Played: "<<user->games<<endl;
        cout<<"Total Chips Won: "<<user->chipTot<<endl;
